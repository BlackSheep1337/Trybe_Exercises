...
const orderModifier = (order) => {
  ...
  order.order.drinks.coke.price = '50,00';
  console.log(`Ola ${order.name}, o total do seu pedido de muzzarella, calabresa e ${order.order.drinks.coke.type} eh R$ ${order.order.drinks.coke.price}`);
}
